...
namespace sl {
    namespace zed {
        ...
        public:
            ...
            /*!
             *  \brief Get the value of the image at the given coordinate
             * 
             * \param x coordinate
             * \param y coordinate
             *
            ...
            /*!
             *  \brief Setting up the buffer metadata
             * 
             * \param width : width of the image in pixels
             * \param height : height of the image in pixels
            ...
            /*!
             *  \brief Allocate the memory with the metadata previously set
             *
            ...
            /*!
             *  \brief Function to get the width of the image in bytes,
            ...
            /*!
             *  \brief Function to get the size of the buffer type
             * 
            ...
            /*!
             *  \brief Print in the standard output information about the Mat
             * 
             */
            void info();
